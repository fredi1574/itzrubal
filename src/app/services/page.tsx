...
const services = [
  ...
  {
    icon: "📸",
    title: "סטיילינג לצילומים",
    subtitle: "הכנת הבית למכירה או השכרה",
    description:
      "הכנת הנכס לצילום מקצועי למכירה או השכרה - סידור, עיצוב וסטיילינג שמדגיש את היתרונות.",
    features: [
      "ניתוח והכנת החלל",
      "סידור רהיטים אופטימלי",
      "הוספת אלמנטי סטיילינג",
      "הדגשת נקודות חוזק",
      "ליווי ביום הצילום",
    ],
  },
  {
    icon: "🖥️",
    title: "קונספט ותלת-ממד",
    subtitle: "להראות את החזון לפני הביצוע",
    description:
      "פיתוח קונספט עיצובי מלא עם הדמיות תלת-ממד שמאפשרות לראות את התוצאה לפני תחילת העבודה.",
    features: [
      "פיתוח קונספט עיצובי",
      "לוח השראה (Mood Board)",
      "הדמיות תלת-ממד מפורטות",
      "תוכניות ריהוט מדויקות",
      "פלטת צבעים וחומרים",
    ],
  },
] as const;
...
const processSteps = [
  { number: "1", title: "פגישת היכרות", text: "נפגש, נדבר על החזון, הצרכים והחלומות שלכם." },
  { number: "2", title: "תכנון והצעה", text: "אכין עבורכם הצעה מפורטת עם קונספט ראשוני." },
  { number: "3", title: "עיצוב ופיתוח", text: "נעבוד יחד על הפיתוח המלא של העיצוב." },
  { number: "4", title: "ביצוע והשלמה", text: "אלווה אתכם עד לרגע שהמפתח מסתובב בדלת." },
] as const;
...
const HeroSection = (): JSX.Element => (
  <section className="services-hero">
    ...
    <p className="services-hero-text">מייעוץ ראשוני ועד ליווי מלא - אני כאן כדי להפוך את החלל שלכם לבית</p>
  </section>
);
...
const CtaSection = (): JSX.Element => (
  <section className="services-cta">
    ...
    <p className="services-cta-text">אשמח לשמוע על הפרויקט שלכם ולגלות יחד איך אני יכולה לעזור</p>
